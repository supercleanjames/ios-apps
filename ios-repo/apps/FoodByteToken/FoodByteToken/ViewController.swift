...
final class ViewController: UIViewController {
    ...
    // MARK: - Configuration
    private let targetURL = URL(string: "https://fast-food-coin.replit.app")!
    private let wordmark = "FOODBYTE TOKEN"
    private let tagline = "Tokenized supply chain for the food industry"
    private let brandBackground = UIColor(hexString: "1A1206")
    private let brandAccent = UIColor(hexString: "FF8C42")
...
final class DisclaimerViewController: UIViewController {
    ...
    private let body = """
    FoodByte Token is an experimental peer-to-peer network token. Settlement runs on Polygon.
    ...
    CONTRACT
    Polygon: 0x37E397B1D470fc1094504D9E60879b7d7F322205

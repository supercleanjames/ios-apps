...
final class ViewController: UIViewController {
    ...
    // MARK: - Configuration
    private let targetURL = URL(string: "https://wellness-guide-and-digital-asset-2.replit.app")!
    private let wordmark = "GOODDOCTOR WELLNESS"
    private let tagline = "Telehealth and wellness tracking"
    private let brandBackground = UIColor(hexString: "06141A")
    private let brandAccent = UIColor(hexString: "3FA9F5")
    ...
    private func setUpLoadingView() {
        ...
        loadingDisclaimer.text = "AI-assisted content · Not an offer to sell"
    ...
    private func setUpDisclaimerBar() {
        ...
        let label = UILabel()
        label.text = "AI-assisted content · Informational only · Nothing for sale — tap for details"
...
final class DisclaimerViewController: UIViewController {
    ...
    private let body = """
    Good Doctor is an experimental peer-to-peer network token. Settlement runs on Polygon.
    ...
    GDOC has no determinable market value. There is no exchange listing, no liquidity pool, and no established price. Any figure shown in this app or on the linked website is AI-generated or AI-assisted and illustrative only. It is not a price, a valuation, a forecast, or a projection of future value, and it must not be relied on for any purpose.

    NOTHING IS FOR SALE
    No token is offered or sold in this app. Nothing here is an offer, a solicitation, or a recommendation to buy, sell, or hold any digital asset.
    ...
    CONTRACT
    Polygon: 0x0c2C02d80A70EF8B245C955E47FBCb264fC79c32
    Verify independently on a public block explorer. Confirm the address character by character before interacting with any contract.
    """

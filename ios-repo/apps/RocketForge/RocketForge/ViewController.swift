...
final class ViewController: UIViewController {
    ...
    // MARK: - Configuration
    private let targetURL = URL(string: "https://rocket-blueprint-catalog.replit.app")!
    private let wordmark = "ROCKETFORGE"
    private let tagline = "Engineering blueprints for rocket propulsion"
    private let brandBackground = UIColor(hexString: "12080A")
    private let brandAccent = UIColor(hexString: "FF5533")
...
final class DisclaimerViewController: UIViewController {
    ...
    private let body = """
    ROCKETFORGE presents informational and reference content.

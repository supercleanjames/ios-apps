...
final class ViewController: UIViewController {
    ...
    // MARK: - Configuration
    private let targetURL = URL(string: "https://ai-chip-marketplace-1.replit.app")!
    private let wordmark = "IOT AI CHIP MARKET"
    private let tagline = "Marketplace for AI edge computing chips"
    private let brandBackground = UIColor(hexString: "0C0C14")
    private let brandAccent = UIColor(hexString: "7B61FF")
...
final class DisclaimerViewController: UIViewController {
    ...
    private let body = """
    IOT AI CHIP MARKET presents informational and reference content.

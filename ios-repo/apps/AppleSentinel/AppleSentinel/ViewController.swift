...
final class ViewController: UIViewController {
    ...
    // MARK: - Configuration
    private let targetURL = URL(string: "https://applesentinel.com")!
    private let wordmark = "APPLE SENTINEL"
    private let tagline = "Bug bounty program tracker for security researchers"
    private let brandBackground = UIColor(hexString: "0A0E14")
    private let brandAccent = UIColor(hexString: "3DDC84")
...
final class DisclaimerViewController: UIViewController {
    ...
    private let body = """
    APPLE SENTINEL presents informational and reference content.

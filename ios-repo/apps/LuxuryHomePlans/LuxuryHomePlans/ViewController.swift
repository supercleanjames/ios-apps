...
final class ViewController: UIViewController {
    ...
    // MARK: - Configuration
    private let targetURL = URL(string: "https://luxury-home-plans.replit.app")!
    private let wordmark = "LUXURY HOME PLANS"
    private let tagline = "Architectural documentation for 20 residences"
    private let brandBackground = UIColor(hexString: "10161F")
    private let brandAccent = UIColor(hexString: "C8A24A")
...
final class DisclaimerViewController: UIViewController {
    ...
    private let body = """
    LUXURY HOME PLANS presents informational and reference content.

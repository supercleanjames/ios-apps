...
final class ViewController: UIViewController {
    ...
    // MARK: - Configuration
    private let targetURL = URL(string: "https://wealth-sage-supercleanjames.replit.app")!
    private let wordmark = "WEALTHSAGE AI"
    private let tagline = "AI-powered personal finance guidance"
    private let brandBackground = UIColor(hexString: "0B1210")
    private let brandAccent = UIColor(hexString: "D4AF37")
...
final class DisclaimerViewController: UIViewController {
    ...
    private let body = """
    WealthSage Token is an experimental peer-to-peer network token. Settlement runs on Polygon.
    ...
    CONTRACT
    Polygon: 0x1116827d844D7871315De6955C101bB9e99F6B31

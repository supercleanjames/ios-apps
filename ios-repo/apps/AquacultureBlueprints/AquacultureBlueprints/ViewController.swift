...
final class ViewController: UIViewController {
    ...
    // MARK: - Configuration
    private let targetURL = URL(string: "https://aquatic-blueprint-manager.replit.app")!
    private let wordmark = "AQUACULTURE BLUEPRINTS"
    private let tagline = "Engineering blueprints for aquaculture systems"
    private let brandBackground = UIColor(hexString: "062024")
    private let brandAccent = UIColor(hexString: "2EC4B6")
    ...
    private func setUpLoadingView() {
        ...
        loadingDisclaimer.text = "AI-assisted content · Informational only"
    ...
    private func setUpDisclaimerBar() {
        ...
        let label = UILabel()
        label.text = "AI-assisted content · Informational only — tap for details"
...
final class DisclaimerViewController: UIViewController {
    ...
    private let body = """
    AQUACULTURE BLUEPRINTS presents informational and reference content.
    ...
    Plans, designs, specifications, figures, and descriptions in this app are informational and may contain errors or omissions. They are not professional advice — including engineering, architectural, construction, legal, financial, or medical advice — and are not a substitute for review by a qualified licensed professional or compliance with applicable codes, permits, and regulations.

    NO WARRANTY
    Content is provided as is, without warranty of any kind. Accuracy, completeness, and availability are not guaranteed.
    """

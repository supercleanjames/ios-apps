...
final class ViewController: UIViewController {
    ...
    // MARK: - Configuration
    private let targetURL = URL(string: "https://data-center-designs-1.replit.app")!
    private let wordmark = "SERVERFORGE"
    private let tagline = "Data center and server rack blueprints"
    private let brandBackground = UIColor(hexString: "090C10")
    private let brandAccent = UIColor(hexString: "30D5C8")
...
final class DisclaimerViewController: UIViewController {
    ...
    private let body = """
    SERVERFORGE presents informational and reference content.

...
final class ViewController: UIViewController {
    ...
    // MARK: - Configuration
    private let targetURL = URL(string: "https://coin-bot-trade-supercleanjames.replit.app")!
    private let wordmark = "COINBOT TRADE"
    private let tagline = "Automated crypto trading bot dashboard"
    private let brandBackground = UIColor(hexString: "0B0F1A")
    private let brandAccent = UIColor(hexString: "F2A900")
...
final class DisclaimerViewController: UIViewController {
    ...
    private let body = """
    COINBOT TRADE presents informational content only.

...
final class ViewController: UIViewController {
    ...
    // MARK: - Configuration
    private let targetURL = URL(string: "https://creativemusicnexus.com")!
    private let wordmark = "CREATIVE MUSIC NEXUS"
    private let tagline = "A hub for creative music collaboration"
    private let brandBackground = UIColor(hexString: "140A1F")
    private let brandAccent = UIColor(hexString: "B57BFF")
...
final class DisclaimerViewController: UIViewController {
    ...
    private let body = """
    CREATIVE MUSIC NEXUS presents informational and reference content.

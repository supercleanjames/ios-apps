...
final class ViewController: UIViewController {
    ...
    // MARK: - Configuration
    private let targetURL = URL(string: "https://ip-core-market.replit.app")!
    private let wordmark = "IP CORE MARKETPLACE"
    private let tagline = "Licensing marketplace for semiconductor IP cores"
    private let brandBackground = UIColor(hexString: "0A1420")
    private let brandAccent = UIColor(hexString: "00B4D8")
...
final class DisclaimerViewController: UIViewController {
    ...
    private let body = """
    IP CORE MARKETPLACE presents informational and reference content.

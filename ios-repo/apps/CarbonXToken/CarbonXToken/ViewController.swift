...
final class ViewController: UIViewController {
    ...
    // MARK: - Configuration
    private let targetURL = URL(string: "https://carbonx-ico.replit.app")!
    private let wordmark = "CARBONX"
    private let tagline = "Peer-to-peer network · Polygon & Hedera"
    private let brandBackground = UIColor(hexString: "0A0E0C")
    private let brandAccent = UIColor(hexString: "14C38E")
...
final class DisclaimerViewController: UIViewController {
    ...
    private let body = """
    Carbon X Token is an experimental peer-to-peer network token. Settlement runs on Polygon.
    ...
    CONTRACT
    Polygon: 0xDEb6E694111298ba130209Fb688A960a8Fb5637a

...
final class ViewController: UIViewController {
    ...
    // MARK: - Configuration
    private let targetURL = URL(string: "https://coin-mint-by-james-ronald-williams-jr-supercleanjames.replit.app")!
    private let wordmark = "COINMINT TOKEN"
    private let tagline = "Token minting and treasury dashboard"
    private let brandBackground = UIColor(hexString: "0D1117")
    private let brandAccent = UIColor(hexString: "FFD166")
...
final class DisclaimerViewController: UIViewController {
    ...
    private let body = """
    COINMINT TOKEN presents informational content only.
